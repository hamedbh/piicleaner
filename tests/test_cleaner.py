...
class TestPIICleaning:
    ...
    def test_clean_list_invalid_elements(self, cleaner):
        ...
        with pytest.raises(TypeError, match="All values in list must be `str`"):
            cleaner.clean_list(["valid string", 123, "another string"], "redact")
...
class TestEdgeCases:
    ...
    def test_very_long_text(self):
        ...
        text_with_pii = base_text + " Contact john@example.com for help " + base_text
